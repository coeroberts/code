-- Katherine messed with Vinh's new query AGAIN
...
(
	...
	(
		...
		from src.nrt_subscription_price sub
			left join revenue rev on sub.subscription_id = rev.product_subscription_id
