...
# required for Windows
dest_dir1 = str.format("deploy-{}", project_name)
...
for filename in glob.glob(common_dir + "/actionScripts/*"):
...
# required for Windows
scpCommand = str.format("scp {} -r {} {}@{}.prod.avvo.com:~", SSH_EXTRA_OPTIONS, dest_dir1, username, gateway)
