...
--   ,raw.data_months
--   ,raw.new_customers_sum / (raw.data_months / 3) AS       new_customers_sum
--   ,raw.retained_customers_sum / (raw.data_months / 3) AS  retained_customers_sum
--   ,raw.retained_customers_avg
--   ,raw.new_mrr_sum / (raw.data_months / 3) AS             new_mrr_sum
--   ,raw.retained_mrr_sum / (raw.data_months / 3) AS        retained_mrr_sum
...
--   ,raw.tenure_year_month
--   ,raw.data_months
--   ,raw.new_customers_sum / (raw.data_months / 12) AS       new_customers_sum
--   ,raw.retained_customers_sum / (raw.data_months / 12) AS  retained_customers_sum
--   ,raw.retained_customers_avg
--   ,raw.new_mrr_sum / (raw.data_months / 12) AS             new_mrr_sum
--   ,raw.retained_mrr_sum / (raw.data_months / 12) AS        retained_mrr_sum
--   ,raw.retained_mrr_avg
-- FROM
--   (
  SELECT
