...
SELECT
  ...
  ,prior_month_customers_sum - retained_customers_sum AS churned_customers_sum
  ,prior_month_customers_avg - retained_customers_avg AS churned_customers_avg
  ,new_mrr_sum
  ...
  ,prior_month_mrr_sum
  ,prior_month_mrr_avg
  ,prior_month_mrr_sum - retained_mrr_sum AS churned_mrr_sum
  ,prior_month_mrr_avg - retained_mrr_avg AS churned_mrr_avg
FROM
  (
  ...
  SELECT
    ...
    ,raw.prior_month_customers_sum / (raw.data_months/raw.cohort_length) AS  prior_month_customers_sum
    ...
    ,raw.prior_month_mrr_sum / (raw.data_months/raw.cohort_length) AS        prior_month_mrr_sum
